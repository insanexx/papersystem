...
<html lang="en">
  ...
  <body class="text-center">
    ...
    <form class="form-signin" action="${pageContext.request.contextPath }/teacher/TeacherServlet?method=login" method="POST">
      ...
      <input type="text" id="xm" class="form-control" placeholder="姓名" required autofocus name="xm" value="${teacher.xm}">
